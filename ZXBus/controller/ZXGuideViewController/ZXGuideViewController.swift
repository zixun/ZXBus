...
public class ZXGuideViewController: UIViewController {
    ...
    override public func viewDidLoad() {
        ...
        self.enterButton.addTarget(self, action: #selector(ZXGuideViewController.enterButtonTap), forControlEvents: UIControlEvents.TouchUpInside)
        
       
        self.pageControl.addTarget(self, action: #selector(ZXGuideViewController.pageControlValueChange), forControlEvents: UIControlEvents.ValueChanged)
    ...
    func pageControlValueChange()  {
        let point = CGPointMake(CGFloat(self.pageControl.currentPage) * ZXScreenWidth(), 0)
    ...
    override public func viewWillLayoutSubviews() {
        ...
        rect.size.height = 35
        rect.origin.y = self.view.bounds.height - rect.size.height - 15
        rect.size.width = 100
        ...
        rect.size.height = 40
        rect.origin.y = self.view.bounds.height - rect.size.height - 40
        rect.size.width = 180
